...
defbindings("WScreen", {
    ...
    kpress(META.."1", "mod_query.workspace_handler(nil, 'compile')"),
    kpress(META.."2", "mod_query.workspace_handler(nil, 'browser')"),
    kpress(META.."3", "mod_query.workspace_handler(nil, 'irc')"),
    kpress(META.."4", "mod_query.workspace_handler(nil, 'float')"),
    kpress(META.."5", "mod_query.workspace_handler(nil, 'apps')"),
    kpress(META.."6", "mod_query.workspace_handler(nil, 'research')"),
    kpress(META.."7", "mod_query.workspace_handler(nil, 'feature')"),
    -- Second screen
    kpress(EXTMETA.."1", "mod_query.workspace_handler(nil, '2main')"),
    kpress(EXTMETA.."2", "mod_query.workspace_handler(nil, '2browser')"),
    kpress(EXTMETA.."3", "mod_query.workspace_handler(nil, '2apps')"),
    kpress(EXTMETA.."4", "mod_query.workspace_handler(nil, '2gimp')"),
    kpress(EXTMETA.."9", "mod_query.workspace_handler(nil, '2movie')"),
